...
export const SET_PROBLEMS_SORT_BY_LENGTH = 'SET_PROBLEMS_SORT_BY_LENGTH'
...
export const set_problems_sort_by_length = (problems_sort_by_length) => ({type: SET_PROBLEMS_SORT_BY_LENGTH, problems_sort_by_length})
